...
# default batch_size = 14 for 2070 Super
python3 detect_and_track_final_submission.py --input /data/test_data  --output counting/track_results --weights detection/yolov5/weights/yolov5x.pt
